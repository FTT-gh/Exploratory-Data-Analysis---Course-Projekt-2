...
png("plot4.png")
  ...
  g + geom_line() + geom_point() + labs(x = "Years") + labs(y = "Emissions from PM2.5 (emitted, in tons)") + labs(title = "Coal combustion-related sources from 1999–2008") + theme(plot.title = element_text(hjust = 0.5))
dev.off()
